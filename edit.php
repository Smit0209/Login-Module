...
<?php
$q="select * from master_emp where eno=".$_REQUEST['eno'];
                    ...
                    <div class="panel-body">
                        ...
                        <form name="f1" method="post" action="edit_db.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" id="email" required value="<?php echo $row[3];?>">
                            </div>
                            <div class="form-group">
                                <label for="mobile">Mobile:</label>
                                <input type="number"  name="mobile" class="form-control" id="mobile" required value="<?php echo $row[4];?>">
                            </div>
							                          
                            <div class="form-group">
                                <label for="pwd">Password:</label>
                                <input type="password" name="password" class="form-control" id="pwd" required value="<?php echo $row[5];?>">
                            </div>
                            <div class="form-group">
                                <label for="pwd">Confirm Password:</label>
                                <input type="password" name="cpassword" class="form-control" id="pwd" required onBlur="checkpassworddata();" value="<?php echo $row[6];?>">
                            </div>
                            <div class="form-group">
                                <label for="mobile">Salary:</label>
                                <input type="number"  name="salary" class="form-control" id="salary" required value="<?php echo $row[7];?>">
                            </div>  
							<div class="form-group">
